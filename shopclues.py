...
def ReadAsin():
    ...
    genList = ['/footlodge-mens-casual-lace-up-shoes-309.html',
               '/chevit-mens-stylish-112-blue-orange-wash-jeans-fashion-loafers-and-moccasins-shoes-casual-shoes-p-115123973.html', ]
    extracted_data = []
    for i in genList:
